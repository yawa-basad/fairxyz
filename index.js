...
$('#plus_value').on('click', () => {
    let currentValue = parseInt($('#mint_amount').val());
    let newValue = currentValue + 1;

    $('#mint_amount').val(newValue);
})


$('#minutes_value').on('click', () => {
    let currentValue = parseInt($('#mint_amount').val());
...
var minusvalue = v - 0.0084 //it can be userinputted or set by a webpage or estimated by a thirdparty
